...
- (void)viewDidLoad {
    ...
    saveButton.frame = CGRectMake(0, self.view.frame.size.height - kNavAndStatusBarHeight - 49, self.view.frame.size.width, 49);
    saveButton.backgroundColor = [[UIColor colorWithRed:0.13 green:0.13 blue:0.16 alpha:1] colorWithAlphaComponent:0.55];
